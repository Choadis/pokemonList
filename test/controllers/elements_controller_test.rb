...
class ElementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create element" do
    assert_difference('Element.count') do
      post elements_url, params: { element: { element: @element.element, pokemon_id: @element.pokemon_id } }
    end
  ...
  test "should update element" do
    patch element_url(@element), params: { element: { element: @element.element, pokemon_id: @element.pokemon_id } }
